    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div
          className={cn(
            `
            [--teal-gradient:repeating-linear-gradient(100deg,var(--primary-500)_0%,var(--primary-600)_7%,transparent_10%,transparent_12%,var(--primary-700)_16%)]
            [--aurora:repeating-linear-gradient(100deg,var(--primary-500)_10%,var(--primary-600)_15%,var(--primary-400)_20%,var(--primary-300)_25%,var(--primary-500)_30%)]
